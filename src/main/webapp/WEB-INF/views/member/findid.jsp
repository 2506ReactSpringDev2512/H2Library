...
<head>
    ...
    <link rel="stylesheet" href="/sources/User_css/아이디찾기.css">
</head>
<body>  
    <div class="container">
        <div class="header">
        ...
        <div class="main">
			...
			<c:if test="${not empty sessionScope.resultMsg}">
			    <script>alert("${sessionScope.resultMsg}");</script>
			    <c:remove var="resultMsg" scope="request"/>
			</c:if>

            <h2>아이디 찾기</h2>
                <form action="/khlibary/member/findid" method="post" onsubmit="return checkInput()">
