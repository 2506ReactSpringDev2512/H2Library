      ...
      <div id="header">
        ...
        <div id="mainWidthControl">
            ...
            <div id="myPageAndSearch">
                ...
                <div class="searchPlace">
                    <div class="searchContainer">
                        <form action="${ctx}/book/list" method="post" class="innerSearchContainer">
            ...
            <div id="main">
                <!-- 메인 왼쪽 4종 메뉴 -->
                <div id="mainLeft">
                    <div class="mainMenus" id="selected"><a href="${ctx}/member/recode">대여 이력</a></div>
                    <div class="mainMenus" ><a href="${ctx}/member/current">대여중인 도서</a></div>
                    <div class="mainMenus"><a href="${ctx}/member/modify">개인정보 수정</a></div>
                ...
                <div id="mainRight">
                    ...
                    <div class="searchPlace">
                        <div class="searchContainer">
                               <form action="${ctx}/member/recode " method="post" class="innerSearchContainer">
                                ...
                                <input type="submit" value="기록검색" class="searchBtn">
                                    <img src="../image/search_30dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.png" alt="">
                                </input>
                               </form>
                        </div>
                    </div>
